...
public class DmsNonDrugItemRecord {
    ...
    public String getAim() { return aim; } public void setAim(String aim) { this.aim = aim; }
    public String getDemand() { return demand; } public void setDemand(String demand) { this.demand = demand; }
    public Integer getLogStatus() { return logStatus; } public void setLogStatus(Integer logStatus) { this.logStatus = logStatus; }
    ...
    public Long getExcuteStaffId() { return excuteStaffId; } public void setExcuteStaffId(Long excuteStaffId) { this.excuteStaffId = excuteStaffId; }
    public LocalDateTime getLogDatetime() { return logDatetime; } public void setLogDatetime(LocalDateTime logDatetime) { this.logDatetime = logDatetime; }
    public Long getNoDrugId() { return noDrugId; } public void setNoDrugId(Long noDrugId) { this.noDrugId = noDrugId; }
    public String getCheckParts() { return checkParts; } public void setCheckParts(String checkParts) { this.checkParts = checkParts; }
    public Integer getType() { return type; } public void setType(Integer type) { this.type = type; }
    public Long getExcuteDeptId() { return excuteDeptId; } public void setExcuteDeptId(Long excuteDeptId) { this.excuteDeptId = excuteDeptId; }
    ...
    public Long getLogStaffId() { return logStaffId; } public void setLogStaffId(Long logStaffId) { this.logStaffId = logStaffId; }
    public LocalDateTime getExcuteTime() { return excuteTime; } public void setExcuteTime(LocalDateTime excuteTime) { this.excuteTime = excuteTime; }
