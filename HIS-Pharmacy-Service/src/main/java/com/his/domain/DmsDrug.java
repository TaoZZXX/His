...
public class DmsDrug {
    ...
    private Long dosageId; private Long typeId; private String mnemonicCode; private LocalDateTime createDate; private Long stock; private String genericName; private Integer status;
    ...
    public LocalDateTime getCreateDate(){return createDate;} public void setCreateDate(LocalDateTime createDate){this.createDate=createDate;} public Long getStock(){return stock;} public void setStock(Long stock){this.stock=stock;}
    public String getGenericName(){return genericName;} public void setGenericName(String genericName){this.genericName=genericName;} public Integer getStatus(){return status;} public void setStatus(Integer status){this.status=status;}
}
