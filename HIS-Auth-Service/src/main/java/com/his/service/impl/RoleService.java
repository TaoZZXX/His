...
public class RoleService implements IRoleService {
    ...
    private final SmsRoleMapper roleMapper;
    private final PermissionUrlRedisCache permissionUrlRedisCache;

    public RoleService(SmsRoleMapper roleMapper, PermissionUrlRedisCache permissionUrlRedisCache) {
    ...
    private List<PermissionNode> buildTree(List<PermissionNode> flat) {
        ...
        for (PermissionNode n : flat) map.put(n.getId(), n);
