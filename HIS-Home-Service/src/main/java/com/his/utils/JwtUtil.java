...
public class JwtUtil {
    ...
    public String generateToken(Long userId, String username) {
        ...
        claims.put("userId", userId); claims.put("username", username);
    ...
    public boolean validateToken(String token) {
        Claims c = parseToken(token); return c != null && !c.getExpiration().before(new Date());
    }
    public Long getUserIdFromToken(String token) {
        Claims c = parseToken(token); return c == null ? null : c.get("userId", Long.class);
    }
}
